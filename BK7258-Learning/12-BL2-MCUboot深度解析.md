...
- [10-Bootloader总览与启动链](./10-Bootloader总览与启动链.md) —— 在启动链中的位置
- [11-BL1深度解析](./11-BL1深度解析.md) —— BL1 如何加载 BL2
- [13-Flash分区布局](./13-Flash分区布局.md) —— 主备槽位
- [14-安全启动与签名](./14-安全启动与签名.md) —— 验签/回滚保护
