...
- [22-驱动适配范式](./22-驱动适配范式.md) —— 驱动范式基础
- [24-外设驱动详解-二(RTC-Timer-ADC)](./24-外设驱动详解-二(RTC-Timer-ADC).md) —— 另一批外设
- [26-驱动注册与常见坑](./26-驱动注册与常见坑.md) —— 常见坑
...
- [08 AP 外设驱动一](./code/08-ap-外设驱动一.md) —— I2C / PWM / GPIOE 逐文件讲解
