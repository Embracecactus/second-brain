...
- [01-芯片与项目背景](./01-芯片与项目背景.md) —— 架构速记
- [10-Bootloader总览与启动链](./10-Bootloader总览与启动链.md) —— 启动链速记
- [20-芯片适配层架构](./20-芯片适配层架构.md) —— 适配层速记
- [22-驱动适配范式](./22-驱动适配范式.md) —— 驱动速记
...
- [00 代码导读](./code/00-代码导读.md) —— 13 篇代码讲解的总导航
