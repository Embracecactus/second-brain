...
|---|---|
| 调试器 | J-Link |
| 接口 | SWD（当前板级验证 P0/P1；P20/P21 备选） |
...
- [02-开发环境与工具链](./02-开发环境与工具链.md) —— 工具链准备
- [10-Bootloader总览与启动链](./10-Bootloader总览与启动链.md) —— 烧录什么
- [13-Flash分区布局](./13-Flash分区布局.md) —— 分区表
- [26-驱动注册与常见坑](./26-驱动注册与常见坑.md) —— 调试驱动
...
- [12 构建与打包工具](./code/12-构建与打包工具.md) —— build_package / bkpack 实现
- [13 分区与板级变体](./code/13-分区与板级变体.md) —— 分区脚本 / postbuild
