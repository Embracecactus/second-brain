...
- [23-外设驱动详解-一(I2C-PWM-GPIOE)](./23-外设驱动详解-一(I2C-PWM-GPIOE).md) —— 范式实例一
- [24-外设驱动详解-二(RTC-Timer-ADC)](./24-外设驱动详解-二(RTC-Timer-ADC).md) —— 范式实例二
- [26-驱动注册与常见坑](./26-驱动注册与常见坑.md) —— 注册与踩坑
- [03-基础概念铺垫](./03-基础概念铺垫.md) —— HAL/驱动分层概念
...
- [08 AP 外设驱动一](./code/08-ap-外设驱动一.md) —— I2C / PWM / GPIOE / RTC / SPI / QSPI
- [09 AP 外设驱动二](./code/09-ap-外设驱动二.md) —— SARADC / CAN / I2S / DMA2D / USB
...
- `$WORKSPACE/nuttx/include/nuttx/i2c/i2c.h`
- `$WORKSPACE/nuttx/include/nuttx/pwm.h`
- `$WORKSPACE/nuttx/include/nuttx/ioexpander.h`
