...
- [01-芯片与项目背景](./01-芯片与项目背景.md) —— 三核/仓库布局
- [21-armino-SDK集成](./21-armino-SDK集成.md) —— SDK 集成
- [22-驱动适配范式](./22-驱动适配范式.md) —— 驱动范式
- [03-基础概念铺垫](./03-基础概念铺垫.md) —— overlay/lower-half 概念
...
- [11 板级初始化](./code/11-板级初始化.md) —— platform / bringup / Flash MTD / 分区
